public class MaxHeap {
    ...
    private void heapifyDown(){
        ...
        while(hasLeftChild(parentIndex)) {
            // assuming left child will be largest
            int largerChildIndex = getLeftChild(parentIndex);
            // if right child exist the largest among both gets precedence
            if(hasRightChild(parentIndex)){
                int rightChildIndex = getRightChild(parentIndex);
                if(leftChild(largerChildIndex) < rightChild(rightChildIndex))
                    largerChildIndex = rightChildIndex;
            }
            // check if violation exist
            if(this.heap[parentIndex] < this.heap[largerChildIndex]){
    ...
    private void heapifyUp(){
        ...
        // check for max heap violation (parent >= both left and right child)
